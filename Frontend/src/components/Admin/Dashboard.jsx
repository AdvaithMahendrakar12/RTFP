  ...
  return (
    <div className="w-screen max-w-full grid grid-cols-1 md:grid-cols-[1fr_5fr] absolute">
      ...
      <div className="border-l border-gray-300 bg-white py-6 px-4">
        <Typography component="h1" className="text-gray-700 font-bold text-3xl text-center mx-auto my-2">
          Dashboard
        </Typography>
        ...
        <div className="flex justify-center bg-white my-4">
          <Link to="/admin/products" className="flex flex-col justify-center items-center text-black font-light text-2xl text-center bg-yellow-200 no-underline py-6 w-40 h-40 mx-8 rounded-full">
            <p>Product</p>
            <p>{products.length}</p>
          </Link>
          <Link to="/admin/orders" className="flex flex-col justify-center items-center font-light text-2xl text-center bg-red-400 text-white no-underline py-6 w-40 h-40 mx-8 rounded-full">
            <p>Orders</p>
            <p>{orders.length}</p>
          </Link>
          <Link to="/admin/users" className="flex flex-col justify-center items-center font-light text-2xl text-center bg-gray-600 text-white no-underline py-6 w-40 h-40 mx-8 rounded-full">
            <p>Users</p>
            <p>{users?.users.length}</p> {/* Display the length of users array */}
          </Link>
        </div>
